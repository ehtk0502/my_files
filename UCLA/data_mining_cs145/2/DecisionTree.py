...
def compute_info_gain(data, att_name, y_name):
    ...
    for i in range(len(vals)):
        att = data[att_name].values
        type = data[y_name].values
        notweighted = compute_entropy(type[att == vals[i]])
        conditional_entropy += (counts[i] / total_counts)* notweighted
